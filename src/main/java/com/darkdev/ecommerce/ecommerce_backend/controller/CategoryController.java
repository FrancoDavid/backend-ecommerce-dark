...
public class CategoryController {
    ...
    public ResponseEntity<Object> create(@Valid @RequestBody Category category, BindingResult bindingResult) {
        ...
        try {
            ...
            return new ResponseEntity<>(new ApiErrorResponseDTO<>("Category created failed", false, null, null), HttpStatus.BAD_REQUEST);
        }
    }
    ...
    public ResponseEntity<Object> update(@Valid @RequestBody Category category, BindingResult bindingResult) {
        ...
        try {
            ...
            return new ResponseEntity<>(new ApiErrorResponseDTO<>("Category updated failed", false, null, null), HttpStatus.BAD_REQUEST);
        }
    }
    ...
    public ResponseEntity<Object> remove(@PathVariable Integer idCategory) {
        try {
            ...
            return new ResponseEntity<>(new ApiErrorResponseDTO<>("Category removed failed", false, null, null), HttpStatus.BAD_REQUEST);
        }
    }
    ...
    public ResponseEntity<Object> categories() {
        try {
            ...
            return new ResponseEntity<>(new ApiErrorResponseDTO<>("Categories not found", false, null, null), HttpStatus.BAD_REQUEST);
        }
